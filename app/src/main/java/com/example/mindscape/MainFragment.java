//package com.example.mindscape;//package com.example.mindscape;
////
...
//import com.example.mindscape.fragments.ArticleFragment;
//import com.example.mindscape.fragments.CalenderFragment;
//import com.example.mindscape.fragments.DoctorsFragment;
//import com.example.mindscape.fragments.HomeFragment;
//import com.example.mindscape.fragments.UserFragment;
...
public class MainFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.home1:
                        // Start a new activity instead of loading a fragment
                        startActivity(new Intent(MainFragment.this, WebDesign.class));
                        return true;
                    case R.id.home2:
                        fragment = new CalenderFragment();
                        break;
    ...
    private void updateBottomNavigationSelectedItem() {
        Fragment currentFragment = getSupportFragmentManager().findFragmentById(R.id.tab);
        if (currentFragment instanceof HomeFragment)
            bottomNavigationView.setSelectedItemId(R.id.home1);
        else if (currentFragment instanceof ArticleFragment)
            bottomNavigationView.setSelectedItemId(R.id.home2);
